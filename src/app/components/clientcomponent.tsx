            ...
            <div  className={ `  ${ (ishidden || isempty) ?  " invisible" :   ""   }    relative  `}  >
              <table className="table-fixed bg-slate-200 relative    w-full ">
                  ...
                  
                  {
                      theresulttable?.map( 
                        (numList,i) =>(
                          <tr key={i}  className=' active:bg-red-500 '   onClick={ ( )  =>{  setselectedrow(i); console.log('row selected', selectedrow) }  }     >
                ...
                <div className=' bg-yellow-400 flex justify-center'>
                          <button  className='bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full   m-5 ' > open  edit page </button>
